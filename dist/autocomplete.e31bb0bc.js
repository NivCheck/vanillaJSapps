...
require("./style.css");
var suggestionList = ["apple", "ball", "cat", "aerop"];
var suggWrapper = document.getElementsByClassName("suggestion-wrapper")[0];
function inputHandle(e) {
  var keyword = e.target.value;
  var suggs = getSuggestions(keyword);
...
function getSuggestions(key) {
  var filtersuggs = suggestionList.filter(function (i) {
...
//# sourceMappingURL=/autocomplete.e31bb0bc.js.map